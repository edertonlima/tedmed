<?php get_header();?>
		...
		<div id="content">
			...
			?>
				...
				<p class="gotocomments" id="postdate" ><a href="<?php comments_link();?>">Skip to comments</a></p>
				<div class="entry">
					<?php the_content();?>
				</div>
				...
				<div class="social-networks">
					...
					<div class="social-wrap" >
						...
						<a id="sshare" class="mail-it alignright" href="#">	<span style="padding-bottom:5px;">Share it</span> </a> 
						<ul id="shareul">
							<li>
